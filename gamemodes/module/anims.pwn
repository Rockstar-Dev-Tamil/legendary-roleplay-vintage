...
CMD:animlist(playerid, params[])
{
	...
	SendClientMessage(playerid, COLOR_GRAD2, "/wave /deal /taichi /crack /smoke /chat /dance /drinkwater /pedmove /bat /aim");
	...
	SendClientMessage(playerid, COLOR_GRAD5, "/salute /washhands /signal /stop /gesture /idles /lowrider /carchat");
	SendClientMessage(playerid, COLOR_GRAD6, "/sunbathe /kiss/sneak /copa /sexy /holdup /misc /bodypush /walkstyle");
	SendClientMessage(playerid, COLOR_GRAD6, "/lowbodypush /headbutt /airkick /doorkick /elbow /coprun /sitonchair /lean /walk");
	SendClientMessage(playerid, COLOR_GRAD4, "/point /tired /injured /fishing /dodge /what /come /hitch /shifty /traffic /ghands");
